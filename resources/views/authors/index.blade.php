...
<div class="max-w-4xl mx-auto p-6 bg-white rounded shadow-sm">
    <div class="flex justify-between mb-4">
        ...
        <a href="{{ route('authors.create') }}" class="bg-green-600 text-white px-4 py-2 rounded">Добавить автора</a>
    </div>
        ...
        <tbody>
            ...
            <tr class="border-b">
                ...
                <td class="p-2 flex gap-2">
                    <a href="{{ route('authors.edit', $author['id']) }}" class="text-blue-500">Изменить</a>
